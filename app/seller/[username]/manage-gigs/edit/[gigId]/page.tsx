  ...
  const onPublish = async () => {
    ...
    if (!published) {
      publish({ id: params.gigId as Id<"gigs"> }).catch((error) => {
        console.log(error);
        toast.error(
          "Failed to publish, Please make sure there are at least 1 image, 3 offers and a description.",
        );
      });
    } else {
      ...
      <>
        <div className='space-y-12 2xl:px-64 xl:px-36 md:px-12 px-12 '>
          ...
          <form
              ...
              className='space-y-2'
          >
            <Label className='front-normal'>App up to 5 images:</Label>
        ...
        <Description
          ...
          editable={true}
          className='pb-40 mt-12 2xl:px-[200px] xl:px-[900px] xs:px-[17px]'
          gigId={gig._id}
        />
      </>
  )
